    ...
    return TaskAssignment(
        ...
        inputs={
            ...
            "implementation_summary": {
                "implementation_summary": "Implemented greet() and its unit test.",
...
def test_prompt_carries_diff_and_lore(
    ...
    assert "greet('world') returns 'hello, world'" in user_msg
    assert "Implemented greet() and its unit test." in user_msg
